...
import com.example.basehiltdi.ui.presentation.base.viewModel.BaseNavVM
...
import com.example.basehiltdi.ui.presentation.utils.extensions.snackbar
...
abstract class BaseFragment<LB : ViewDataBinding>() : BaseNavFragment() {
    ...
    open fun setStatusBarColor(
        updateColor: Boolean = true,
        color: Int = R.color.white
    ) { // Change by R.color.colorPrimary when all app is migrated a Single Activity
        if (updateColor) {
